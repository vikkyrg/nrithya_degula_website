...
export default function Navbar() {
  ...
  return (
    ...
    >
      ...
      <div 
        className={`lg:hidden absolute w-full bg-[#160B07]/98 backdrop-blur-xl transition-all duration-500 ease-in-out overflow-hidden shadow-2xl ${
          isOpen ? 'max-h-screen opacity-100 border-t border-[#C59A4E]/20' : 'max-h-0 opacity-0'
        }`}
      >
